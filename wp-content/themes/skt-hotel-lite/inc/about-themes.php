...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo esc_url(SKT_LIVE_DEMO_URL); ?>" target="_blank"><?php esc_attr_e('Live Demo', 'skt-hotel-lite'); ?></a> | 
				<a href="<?php echo esc_url(SKT_PRO_THEME_URL); ?>"><?php esc_attr_e('Buy Pro', 'skt-hotel-lite'); ?></a> | 
				<a href="<?php echo esc_url(SKT_THEME_DOC); ?>" target="_blank"><?php esc_attr_e('Documentation', 'skt-hotel-lite'); ?></a>
