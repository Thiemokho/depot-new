...
<div class="col-lg-4 col-md-4">
    ...
    <div class="article_content">
      <div class="metabox"> 
        ...
        <span class="entry-comments"><a href="<?php echo esc_url( get_permalink() );?>"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','negocio-business'), __('0 Comments','negocio-business'), __('% Comments','negocio-business') ); ?></a></span>
      </div>
