...
function vw_gardening_landscaping_admin_theme_style() {
   wp_enqueue_style( 'vw-gardening-landscaping-font', vw_gardening_landscaping_admin_font_url(), array() );
...
// Theme Font URL
function vw_gardening_landscaping_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="openCity(event, 'gardening_lite')"><?php esc_html_e( 'Getting Started', 'vw-gardening-landscaping' ); ?></button>		  
		  <button class="tablinks" onclick="openCity(event, 'gardening_pro')"><?php esc_html_e( 'Get Premium', 'vw-gardening-landscaping' ); ?></button>
		  <button class="tablinks" onclick="openCity(event, 'free_pro')"><?php esc_html_e( 'Support', 'vw-gardening-landscaping' ); ?></button>
		</div>

		<!-- Tab content -->
		<div id="gardening_lite" class="tabcontent open">
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-format-image"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','vw-gardening-landscaping'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_gardening_landscaping_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Settings','vw-gardening-landscaping'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_gardening_landscaping_topbar') ); ?>" target="_blank"><?php esc_html_e('Topbar Settings','vw-gardening-landscaping'); ?></a>
							</div>
							<div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-editor-aligncenter"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','vw-gardening-landscaping'); ?></a>
							</div>
							<div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_gardening_landscaping_left_right') ); ?>" target="_blank"><?php esc_html_e('Blog Layout','vw-gardening-landscaping'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_gardening_landscaping_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','vw-gardening-landscaping'); ?></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-right-inner">
                ...
                <ul>
                	<li><?php esc_html_e('1. Create a Page to set template:  Go to ','vw-gardening-landscaping'); ?>
                  	<b><?php esc_html_e('Dashboard &gt;&gt; Pages &gt;&gt; Add New Page','vw-gardening-landscaping'); ?></b>.
                  	<p><?php esc_html_e('Label it "home" or anything as you wish. Then select template "home-page" from template dropdown.','vw-gardening-landscaping'); ?></p></li>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/home-page-template.png" alt="" />
                  	<p></p><span class="strong"><?php esc_html_e('2. Set the front page:','vw-gardening-landscaping'); ?></span><?php esc_html_e(' Go to ','vw-gardening-landscaping'); ?>
				  	<b><?php esc_html_e(' Settings -&gt; Reading --&gt; Set the front page display static page to home page ','vw-gardening-landscaping'); ?></b></p>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/set-front-page.png" alt="" />
                  	<p><?php esc_html_e(' Once you are done with this, you can see all the demo content on front page. ','vw-gardening-landscaping'); ?></p>
                </ul>
		  	</div>
		</div>	
