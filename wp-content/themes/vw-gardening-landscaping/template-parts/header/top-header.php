  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 col-md-4">
        <div class="row">
          <div class="<?php if( get_theme_mod( 'vw_gardening_landscaping_search_hide_show') != '') { ?>col-lg-11 col-md-10"<?php } else { ?>col-lg-12 col-md-12"<?php } ?>">
            <?php dynamic_sidebar('social-links'); ?>
          </div>
          <?php if( get_theme_mod( 'vw_gardening_landscaping_search_hide_show') != '') { ?>
