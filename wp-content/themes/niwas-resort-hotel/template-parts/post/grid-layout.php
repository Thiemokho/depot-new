    ...
    <div class="article_content">   
      <div class="article-text">
        ...
        <div class="metabox"> 
          ...
          <span class="entry-comments"><a href="<?php echo esc_url( get_permalink() );?>"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','niwas-resort-hotel'), __('0 Comments','niwas-resort-hotel'), __('% Comments','niwas-resort-hotel') ); ?></a></span>
        </div>
      </div>
