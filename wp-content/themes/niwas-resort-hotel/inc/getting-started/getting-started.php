...
<div class="wrapper-info">
	<div class="col-left">
		...
		<div class="started">
			...
			<div class="free-doc">
				<div class="lz-4">
					<h4><?php esc_html_e( 'Help Docs', 'niwas-resort-hotel' ); ?></h4>
					<ul>
						<span><?php esc_html_e( 'niwas-resort-hotel', 'niwas-resort-hotel' ); ?> <a href="<?php echo esc_url( NIWAS_RESORT_HOTEL_PRO_DOCS ); ?>" target="_blank"> <?php esc_html_e( 'Documentation', 'niwas-resort-hotel' ); ?></a></span>
					</ul>
				</div>
				<div class="lz-4">
