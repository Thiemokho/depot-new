			...
			<div class="service-box">
				<div class="service-title">
					<?php if( get_theme_mod('niwas_resort_hotel_our_facilities_title') != ''){ ?>
			    		<h3><?php echo esc_html(get_theme_mod('niwas_resort_hotel_our_services_title','')); ?></h3>
			    	<?php }?>
	            ...
	            <div class="row">
		      		<?php
		      		 $catData1=  get_theme_mod('niwas_resort_hotel_category_setting');
              			if($catData1){ 
		      		$page_query = new WP_Query(array( 'category_name' => esc_html($catData1 ,'niwas-resort-hotel')));?>
