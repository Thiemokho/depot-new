...
add_filter( 'themeisle_sdk_products', 'metrox_load_sdk' );
/**
 ...
 */
function metrox_load_sdk( $products ) {
		...
		<div id="comment-<?php comment_ID(); ?>" class="comment">
			...
			<div class="comm_content">
				...
				<?php
					...
					printf(
						'<b><a href="%1$s"><time datetime="%2$s">%3$s</time></a></b>',
				...
				<div class="reply">
					<?php comment_reply_link(
						array_merge(
							$args, array(
							'reply_text' => __( 'Reply', 'metro-creativex' ),
